...
\textbf{Real-World Performance:} Across 11 benchmark datasets~[4], EADD achieved 0\% missed detection rate with 3.7\% lower mean time to detection than D3 (1,661 vs.\ 1,725 samples).
