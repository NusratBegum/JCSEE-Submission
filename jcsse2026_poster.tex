...
\textit{Can discriminative classification be extended with permutation testing and feature attribution to provide statistically sound, explainable, and actionable drift detection across diverse drift types?}
\end{block}
